...
import { Input, Button, Switch, Select, SelectItem, Spacer, addToast, Spinner } from '@heroui/react'
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        ...
        <Button type="submit" color="primary" fullWidth> Créer le compte</Button>
